<template>
    <div class="mb-5">
        <div class="sticky top-0 navbar flex-wrap bg-base-100 mb-8 mt-4 pb-4 border-b-[0.5px] px-8 z-50">
            <div class="flex-grow">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 lg:gap-12 mx-8 md:mx-auto md:max-w-[80%]">
            <a :href="`/cocktail/${recommendation.slug}`" class="card w-full shadow-xl group transition-[background-size] bg-center bg-[length:100%_auto] hover:bg-[length:105%_auto]" :style="{
                ...
                <div class="card-body z-20 py-10 md:h-48">
                    <h2 class="card-title text-white md:text-3xl">Cocktail of the {{ key }}</h2>
